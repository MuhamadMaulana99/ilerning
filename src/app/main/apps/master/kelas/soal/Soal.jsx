...
function Soal(props) {
  ...
  const getData = async () => {
    ...
    const response = await axios
      .get(`${process.env.REACT_APP_API_URL_API_}${api}/${dataEdit?.row?.id}`, header)
      .then((res) => {
  ...
  return (
    <div>
      <div>
        <AddSoal getData={getData} dataEdit={dataEdit} header={header} getUser={getUser} />
      </div>
      <SoalTable
        getData={getData}
        listDosen={[]}
